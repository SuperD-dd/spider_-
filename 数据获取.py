...
class Spider(object):
    ...
    async def scrape_index(self, item):
        url = f'https://nc.lianjia.com/ershoufang/{item[0]}/pg{item[1]}/'
    ...
    async def parse(self, item, text):
        ...
        try:
            ...
            print(e)
    def main(self):
        regions = ['donghuqu','nanchangxian','anyixian','xinjianqu','wanliqu','honggutan','xihuqu','jinxianxian',
                   'qingyunpuqu','qingshanhuqu','gaoxinqu','jingkaiqu']
