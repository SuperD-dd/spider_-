...
regions_dic = {'donghuqu': '东湖区', 'nanchangxian': '南昌县', 'anyixian': '安义县', 'xinjianqu': '新建区','wanliqu': '湾里区', 'honggutan': '红谷滩', 'xihuqu': '西湖区',
               'jinxianxian': '进贤县', 'qingyunpuqu': '青云谱区', 'qingshanhuqu': '青山湖区', 'gaoxinqu': '高新区', 'jingkaiqu': '经开区'}
...
def draw(xlist, ylist1, ylist2, ylist3):
    c = (
        Bar(init_opts=opts.InitOpts(
            ...
            .set_global_opts(
            title_opts=opts.TitleOpts(title="南昌各区最低/平均/最高房价单价情况直方图"),
        )
            .render('分析图表/' + "南昌各区最低-平均-最高房价单价情况直方图.html")
    )
